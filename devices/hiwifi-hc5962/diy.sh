...
cp -f $GITHUB_WORKSPACE/devices/hiwifi-hc5962/mt7621_asus_rt-n56u-b1.dts ./target/linux/ramips/dts/
cp -f $GITHUB_WORKSPACE/devices/hiwifi-hc5962/mt7621_hiwifi_hc5962.dts ./target/linux/ramips/dts/
