...
```
screen -S openwrt
wget -O compile.sh https://raw.githubusercontent.com/lon91ong/OpenWrt/master/onekey/compile.sh && bash compile.sh
```

 二次编译:
```
screen -S openwrt
wget -O recompile.sh https://raw.githubusercontent.com/lon91ong/OpenWrt/master/onekey/recompile.sh && bash recompile.sh
```
